...
UINT Backend::g_ResizeWidth = 0;
UINT Backend::g_ResizeHeight = 0;
...
bool Backend::Render()
{
    ...
    // If you want to use docking, you typically need to create a dockspace
...
LRESULT WINAPI WndProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_SIZE:
        if (wParam == SIZE_MINIMIZED)
            return 0;
        Backend::g_ResizeWidth = (UINT)LOWORD(lParam);
        Backend::g_ResizeHeight = (UINT)HIWORD(lParam);
        return 0;
    case WM_SYSCOMMAND:
